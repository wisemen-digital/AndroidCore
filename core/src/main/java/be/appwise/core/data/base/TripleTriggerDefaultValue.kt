 ...
 * Non nullable variant of {@link TripleTrigger}
 *
 ...
 */
class TripleTriggerDefaultValue<A, B,C>(a: LiveData<A>, b: LiveData<B>,c: LiveData<C>, defaultA : A, defaultB : B, defaultC : C) : MediatorLiveData<Triple<A, B, C>>() {
        init {
